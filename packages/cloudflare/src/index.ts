								...
								generateBundle(_, bundle) {
									...
									if (
										...
										try {
											...
											logger.warn(
												'Failed to clean up ssr entry file from prerendered imports. Please report this issue with a minimal reproduction to https://github.com/withastro/adapters/issues?q=is:issue+is:open+sort:updated-desc.'
											);
										}
									} else {
